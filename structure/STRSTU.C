...
struct studata
{
	...
	char course[20];
	int yoj;
}nos[6] = { 101, "Kishor", "IT", "B.tech", 2014,
102, "Mohammad Siraj Alam", "Computer Science", "B.Tech", 2014,
103, "Deepak", "Computer Applications", "BCA", 2013,
104, "Karan", "Mechanical", "Diploma", 2013,
105, "Aakash", "Tool and Die", "Diploma", 2012,
106, "Ramesh", "IT", "B.tech", 2014
};
